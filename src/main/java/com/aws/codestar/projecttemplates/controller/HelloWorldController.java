...
public class HelloWorldController {
	...
	public ModelAndView memberCenter(HttpServletRequest request, HttpServletResponse response, HttpSession httpSession)
		...
		model.addObject("xmlSource", apiService.memberCenterXml(httpSession.getAttribute("id").toString()));
	...
	public String postComment(Story story, HttpSession httpSession)
		...
		System.out.println("留言--" + jSONArrayComment.toString());
...
//			stringsOfImgurls[i] = jSONObject;
	...
	public ModelAndView homepage(@RequestParam(required = false) String id, HttpSession httpSession) throws ParserConfigurationException, IOException {
